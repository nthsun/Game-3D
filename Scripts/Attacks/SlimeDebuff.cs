...
public class SlimeDebuff : MonoBehaviour
{
	...
	public GameObject SimleHit_Spack;
	...
	{
		SimleHit_Spack.transform.position = targetAttack.transform.position;
		//Forget the target of the debuff and un-parent it from the enemy
		SimleHit_Spack.SetActive (true);
		SimleHit_Spack.GetComponent<ParticleSystem> ().Play ();
	...
	void turnOff() {
		...
		SimleHit_Spack.SetActive (false);
	}

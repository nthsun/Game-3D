...
{
	[SerializeField] float explosionRadius = 2f;	//Radius of the explosion
	...
	void Awake ()
	{
		//whatIsShootable = LayerMask.GetMask ("Shootable");
	}
	...
	void OnEnable()
	{
		...
		enemiesHit = Physics.OverlapSphere(TargetRing.transform.position, explosionRadius, whatIsShootable);
